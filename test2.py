...
def report():
    ...
    Image_open = Image.open("rebg.jpg")
    ...
    listbox1 = Listbox(R15, width=7, borderwidth=0, fg="#3cff00", highlightthickness=0, selectbackground=gg, height=26,
                       bg=gg, font="10")
    listbox1.bind("<MouseWheel>", OnMouseWheel)
    listbox1.place(x=90, y=200)

    listbox2 = Listbox(R15, width=7, height=26, fg="orange", highlightthickness=0, bg=gg, borderwidth=0,
                       selectbackground=gg, font="10")
    listbox2.bind("<MouseWheel>", OnMouseWheel)
    listbox2.place(x=600, y=200)

    listbox3 = Listbox(R15, width=7, borderwidth=0, fg="red", height=26, bg=gg, selectbackground=gg, font="10",
...
def afterlogin():
    ...
    def viewclass():
        ...
        listbox1 = Listbox(R11, width=10, borderwidth=0, highlightthickness=0, selectbackground=gg, height=30, bg=gg,
                           fg=gw, font=("bold", 20))
        listbox1.bind("<MouseWheel>", OnMouseWheel)
        listbox1.place(x=35, y=150)

        listbox2 = Listbox(R11, width=10, height=30, highlightthickness=0, bg=gg, borderwidth=0, selectbackground=gg,
                           fg=gw, font=("bold", 20))
        listbox2.bind("<MouseWheel>", OnMouseWheel)
        listbox2.place(x=270, y=150)

        listbox3 = Listbox(R11, width=20, borderwidth=0, height=30, bg=gg, selectbackground=gg, fg=gw,
                           font=("bold", 20), highlightthickness=0)
        listbox3.bind("<MouseWheel>", OnMouseWheel)
        listbox3.place(x=590, y=150)

        listbox4 = Listbox(R11, width=20, borderwidth=0, height=30, bg=gg, selectbackground=gg, fg=gw,
                           font=("bold", 20), highlightthickness=0)
    ...
    b1 = Button(R2, text="STUDENT AND REPORT", width=48, height=15, bg=g, fg="white", font="5", relief=FLAT,
                overrelief=RIDGE, borderwidth='5', activebackground=gw, command=std_re)
    b1.place(x=100, y=74)
    b1 = Button(R2, text="NEW STUDENT", width=48, height=15, bg=g, fg="white", font="5", relief=FLAT, overrelief=RIDGE,
                borderwidth='5', activebackground=gw, command=new_student)
    b1.place(x=100, y=374)
    b1 = Button(R2, text="NEW ATTENDANCE", width=48, height=15, bg=g, fg="white", font="5", relief=FLAT,
                overrelief=RIDGE, borderwidth='5', activebackground=gw, command=new_atten)
    b1.place(x=730, y=74)
    b1 = Button(R2, text="CREATE NEW CLASS", width=48, height=15, bg=g, fg="white", font="5", relief=FLAT,
                overrelief=RIDGE, borderwidth='5', activebackground=gw, command=create_class)
...
def create_class():
    ...
    b1 = Button(R7, text="ADD", width=20, height=2, bg=gg, fg="white", font="5", relief=RAISED, overrelief=RIDGE,
                command=add)
...
def new_atten():
    ...
    def add_att():
        if (1 + int(e1.get()) > int(e2.get())):
            ...
            try:
                mm.execute("""update """ + p + """ set """ + str(sub.get()) + """=""" + str(
                    e1.get()) + """ where rollno =""" + str(r.get()))
                mm.execute("""update """ + p + """ set atten_""" + str(sub.get()) + """=""" + str(
                    e2.get()) + """ where rollno =""" + str(r.get()))

                a = int(e1.get())
                b = int(e2.get())
                per = b / a * 100
                mm.execute("""update """ + p + """ set per_""" + str(sub.get()) + """=""" + str(
                    per) + """ where rollno =""" + str(r.get()))
                ...
                if (per > 75):
                    ...
                    pass
                mm.execute("""update """ + p + """ set status_""" + str(sub.get()) + """='""" + str(
                    status) + """' where rollno =""" + str(r.get()))
                am.commit()
                ...
                if (pertot > 75):
                    ...
                    pass
                mm.execute(
                    """update """ + p + """ set total""" + """=""" + str(aq) + """ where rollno =""" + str(r.get()))
                mm.execute(
                    """update """ + p + """ set tot_atten""" + """=""" + str(bq) + """ where rollno =""" + str(r.get()))
                mm.execute("""update """ + p + """ set per_tot""" + """=""" + str(pertot) + """ where rollno =""" + str(
                    r.get()))
                mm.execute("""update """ + p + """ set status_tot""" + """='""" + str(
                    totstatus) + """' where rollno =""" + str(r.get()))
                v = "Added " + str(sub.get())
    ...
    button1 = Button(R8, text="ADD", width=30, height=4, bg=gg, fg="white", font="5", relief=RAISED, overrelief=RIDGE,
                     command=add_att)
...
def new_student():
    ...
    def add():
        try:
            ...
            fname = e2.get()
            lname = e3.get()
            cm.execute("""insert into """ + (clas.get()) + """(grno,fname,lname) values(%s,%s,%s)""",
                       (gr, fname, lname))
            cl.commit()
        except:
            l.config(text="something went wrong", fg="red")
    ...
    def grup():
        def up():
            try:
                ...
                cm = cl.cursor()
                cm.execute(
                    "update " + str(cclas.get()) + " set grno=" + str(eg.get()) + " where rollno=" + str(er.get()))
                cl.commit()
            except:
    ...
    def nameup():
        def up():
            try:
                ...
                cm = cl.cursor()
                cm.execute(
                    "update " + str(cclas.get()) + " set fname='" + str(eg.get()) + "' where rollno=" + str(er.get()))
                cm.execute(
                    "update " + str(cclas.get()) + " set lname='" + str(eeg.get()) + "' where rollno=" + str(er.get()))
                cl.commit()
            except:
                lq.config(text="something went wrong", fg="red")
            else:
    ...
    b1 = Button(R6, text="ADD", width=25, height=2, bg=gg, fg="white", font="5", relief=RAISED, overrelief=RIDGE,
                command=add)
...
def std_re():
    ...
    listbox8 = Listbox(R3, width=200, borderwidth=0, highlightthickness=0, selectbackground=gg, height=38, bg=gg, fg=gw,
                       font="10")
    listbox8.bind("<MouseWheel>", OnMouseWheel)
    listbox8.place(x=25, y=125)

    listbox1 = Listbox(R3, width=7, borderwidth=0, highlightthickness=0, selectbackground=gg, height=30, bg=gg, fg=gw,
                       font="10")
    listbox1.bind("<MouseWheel>", OnMouseWheel)
    listbox1.place(x=17, y=125)

    listbox2 = Listbox(R3, width=7, height=30, highlightthickness=0, bg=gg, borderwidth=0, selectbackground=gg, fg=gw,
                       font="10")
    listbox2.bind("<MouseWheel>", OnMouseWheel)
    listbox2.place(x=145, y=125)

    listbox3 = Listbox(R3, width=20, borderwidth=0, height=30, bg=gg, selectbackground=gg, fg=gw, font="10",
                       highlightthickness=0)
    listbox3.bind("<MouseWheel>", OnMouseWheel)
    listbox3.place(x=270, y=125)

    listbox9 = Listbox(R3, width=20, borderwidth=0, highlightthickness=0, selectbackground=gg, height=30, bg=gg, fg=gw,
                       font="10")
    listbox9.bind("<MouseWheel>", OnMouseWheel)
    listbox9.place(x=350, y=125)

    listbox4 = Listbox(R3, width=20, borderwidth=0, height=30, bg=gg, selectbackground=gg, fg=gw, font="10",
                       highlightthickness=0)
    listbox4.bind("<MouseWheel>", OnMouseWheel)
    listbox4.place(x=520, y=125)

    listbox5 = Listbox(R3, width=5, borderwidth=0, height=30, bg=gg, selectbackground=gg, fg=gw, font="10",
                       highlightthickness=0)
    listbox5.bind("<MouseWheel>", OnMouseWheel)
    listbox5.place(x=750, y=125)

    listbox6 = Listbox(R3, width=5, borderwidth=0, height=30, bg=gg, selectbackground=gg, fg=gw, font="10",
                       highlightthickness=0)
    listbox6.bind("<MouseWheel>", OnMouseWheel)
    listbox6.place(x=960, y=125)

    listbox7 = Listbox(R3, width=15, borderwidth=0, height=30, bg=gg, selectbackground=gg, fg=gw, font="10",
                       highlightthickness=0)
...
def login():
    ...
    b1 = Button(R1, text="Login", width=25, height=2, bg=g, fg="white", font="5", relief=RAISED, overrelief=RIDGE,
                command=final)
...
def signup():
    ...
    default = StringVar()
    e4 = Entry(R, width=15, font=("bold", 15), textvariable=default, highlightthickness=2, bg=gw, relief=SUNKEN,
               fg="brown")
    default.set("root")
    e4.place(x=980, y=482)
    e5 = Entry(R, width=15, font=("bold", 15), highlightthickness=2, bg=gw, relief=SUNKEN)
    e5.place(x=980, y=548)
    b1 = Button(R, text="Sign Up", width=25, height=2, bg=g, fg="white", font="5", relief=RAISED, overrelief=RIDGE,
